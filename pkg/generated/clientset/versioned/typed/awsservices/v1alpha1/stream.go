...
import (
	...
	scheme "github.com/anandnilkal/aws-services/pkg/generated/clientset/versioned/scheme"
...
func newStreams(c *AwsservicesV1alpha1Client, namespace string) *streams {
	return &streams{
		client: c.RESTClient(),
		ns:     namespace,
	}

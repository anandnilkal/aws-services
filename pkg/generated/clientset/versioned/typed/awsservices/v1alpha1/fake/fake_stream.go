...
type FakeStreams struct {
	Fake *FakeAwsservicesV1alpha1
	ns   string
}

var streamsResource = schema.GroupVersionResource{Group: "awsservices.k8s.io", Version: "v1alpha1", Resource: "streams"}

var streamsKind = schema.GroupVersionKind{Group: "awsservices.k8s.io", Version: "v1alpha1", Kind: "Stream"}

...
import (
	...
	versioned "github.com/anandnilkal/aws-services/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/anandnilkal/aws-services/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/anandnilkal/aws-services/pkg/generated/listers/awsservices/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AwsservicesV1alpha1().Streams(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AwsservicesV1alpha1().Streams(namespace).Watch(context.TODO(), options)
			},
		},
		&awsservicesv1alpha1.Stream{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *streamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&awsservicesv1alpha1.Stream{}, f.defaultInformer)
}
